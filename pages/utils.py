...
def get_groq_objectivity_score(text: str) -> int | None:
    ...
    system_msg = (
        ...
        "SCORING FRAMEWORK:\n"
        "Evaluate the text across these 5 criteria. Start each at 20 points and deduct points for framing flaws:\n"
        "1. Emotion & Tone (20 pts): Deduct 2-5 points for descriptive adjectives. Deduct 6-12 for overt outrage/sensationalism.\n"
        "2. Perspective Balance (20 pts): Deduct 2-4 points if an opposing side is mostly ignored or minimized.\n"
        "3. Fact vs Opinion (20 pts): Deduct 3-6 points for unverified claims, interpretive analysis, or 'experts say' without names.\n"
        "4. Sourcing Quality (20 pts): Deduct 3-6 points if heavily relying on anonymous sources or biased quotes.\n"
        "5. Headline/Framing (20 pts): Deduct 2-5 points if the framing pushes a specific narrative or is mildly leading.\n\n"
        "RULES:\n"
        "- The 'score' is the SUM of the 5 criteria.\n"
        "- Standard professional news (AP/Guardian) should naturally score between 75 and 88. Almost nothing is perfectly 100.\n"
        "- NEVER output generic numbers like 85, 88, 90, 95. Use exact math (e.g., 83, 76, 81, 74).\n"
        "- Scores below 70 mean the article is highly political or blatantly biased."
    )
